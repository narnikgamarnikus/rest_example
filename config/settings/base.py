...
)  # (rest_example/config/settings/base.py - 3 = rest_example/)
APPS_DIR = ROOT_DIR.path("rest_example")
...
MIGRATION_MODULES = {"sites": "rest_example.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "rest_example.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Vladimir Myshkovski""", "vladimirmyshkovski@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "rest_example.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
